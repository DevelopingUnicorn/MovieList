...
public class OLDMovieLoaderWorker extends SwingWorker<LinkedList<Movie>, Movie> {
    ...
    public OLDMovieLoaderWorker(String path, ProgressbarDLG d, OLDMainUI mui, Locale loc) {
        this.path = path;
